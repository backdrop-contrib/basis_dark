...
/**
 * @file
 * Basis Dark preprocess functions and theme function overrides.
 */

/**
 * Implements hook_css_alter().
 */
function basis_dark_css_alter(&$css) {
  // Remove the Basis Dark css/component/menu-dropdown.css and add breakpoint files
  // if using a custom breakpoint.
  $config = config('menu.settings');
  $path = backdrop_get_path('theme', 'basis_dark');
 ...
 * @see page.tpl.php
 */
function basis_dark_preprocess_page(&$variables) {
  ...
  // The version must be one of the values from basis_dark_updated_css_versions().
  ...
  $update_css_versions = basis_dark_updated_css_versions();
...
/**
 * Returns the versions of Backdrop that contain updated CSS for Basis Dark.
 *
 ...
 * "css_update_version" in basis_dark.settings.json should match the added value.
 */
function basis_dark_updated_css_versions() {
  return array('1.30');
}
 ...
 */
function basis_dark_preprocess_maintenance_page(&$variables) {
  $css_path = backdrop_get_path('theme', 'basis_dark') . '/css/component/maintenance.css';
 ...
 * @see layout.tpl.php
 */
function basis_dark_preprocess_layout(&$variables) {
 ...
 * @see node.tpl.php
 */
function basis_dark_preprocess_node(&$variables) {
 ...
 * @see header.tpl.php
 */
function basis_dark_preprocess_header(&$variables) {
  $logo = $variables['logo'];
 ...
 */
function basis_dark_breadcrumb($variables) {
